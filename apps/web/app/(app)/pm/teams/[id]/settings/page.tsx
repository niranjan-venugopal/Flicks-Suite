              ...
              return (
                <div key={cat} style={{ marginBottom: 12 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 5 }}>
                    ...
                    <span style={{ fontSize: 10.5, fontWeight: 800, letterSpacing: '.07em', textTransform: 'uppercase', color: 'var(--text-faint)' }}>{cat}</span>
                  ...
                  {catStates.map((s) => (
                    <div key={s.id} style={{ display: 'flex', alignItems: 'center', gap: 9, height: 34, padding: '0 6px' }}>
                      ...
                      {s.is_default_for_category && (
                        <span style={{ fontSize: 10.5, fontWeight: 800, color: 'var(--blue)', border: '1px solid rgba(62,123,250,.4)', borderRadius: 6, padding: '1px 6px' }}>default for new issues</span>
                      )}
